...
const sections = [
  ...
  },
  {
    ...
    icon: Handshake,
    body:
      'بعد مرحلة التأسيس، يتم احتساب نسبة الشراكة من إجمالي المبيعات الرقمية للمتجر الإلكتروني فقط، ولا تشمل مبيعات الفروع أو أي قنوات بيع أخرى.',
    table: [
      ['السنة الأولى', '30%'],
      ['السنة الثانية', '25%'],
      ['السنة الثالثة وبعدها', '20%'],
    ],
  },
  {
    order: 'سادساً',
