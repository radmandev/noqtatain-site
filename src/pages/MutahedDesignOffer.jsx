...
const pricingPlans = [
  {
    tier: '🥉 الباقة الأولى',
    price: '5,000 ريال',
    fit: 'مناسبة لمن يرغب في تطوير الموقع القائم بأقل تكلفة.',
    features: [
  ...
  },
  {
    tier: '🥈 الباقة الثانية',
    price: '10,000 ريال',
    fit: 'مناسبة للشركات التي تريد نقلة نوعية في الحضور الرقمي.',
    features: [
  ...
  },
  {
    tier: '🥇 الباقة الثالثة',
    price: '18,000 ريال',
    fit: 'مناسبة للشركات التي تريد موقعًا يعمل كأداة مبيعات متكاملة.',
    features: [
