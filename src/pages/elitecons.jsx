...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .tech-desc { font-size: 13px; color: var(--ink3); line-height: 1.7; }
  ...
  .pkg-name { font-size: 20px; font-weight: 800; margin-bottom: 6px; color: var(--ink2); }
  .pkg-desc { font-size: 13px; color: var(--ink3); line-height: 1.6; margin-bottom: 20px; }
  ...
  .roadmap-title { font-size: 17px; font-weight: 800; margin-bottom: 10px; color: var(--ink2); }
  ...
  .footer {
    ...
    font-size: 12px; color: var(--ink2); background: #f3f5fb;
  }
